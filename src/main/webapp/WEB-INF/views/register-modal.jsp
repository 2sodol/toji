            ...
            <section class="illegal-register-form__section">
              ...
              <div class="illegal-register-grid illegal-register-grid--cols-3">
                <div class="illegal-register-field">
                  ...
                  <input type="text" class="illegal-register-input" id="hdqrNm" value="${loginUserDept}" maxlength="100"
                    required readonly />
                </div>
                <div class="illegal-register-field">
            ...
            <section class="illegal-register-form__section">
              ...
              <div class="illegal-register-grid illegal-register-grid--cols-3">
                ...
                <div class="illegal-register-field">
                  ...
                  <input type="number" class="illegal-register-input" id="ilglPssnSqms" placeholder="예: 10.5" step="0.1"
                    min="0" />
                </div>
                <div class="illegal-register-field">
