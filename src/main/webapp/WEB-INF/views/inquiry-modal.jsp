        ...
        <div class="illegal-inquiry-content-wrapper">
          <div class="illegal-inquiry-content">
            ...
            <div class="illegal-inquiry-sidebar">
              ...
              <div class="illegal-inquiry-date-list" id="inq_detailDateList"></div>
              <div class="illegal-inquiry-sidebar__footer">
                <button type="button" id="inq_photoCompareBtn" class="illegal-inquiry-sidebar__button">
            ...
            <div class="illegal-inquiry-main">
              <div class="illegal-inquiry-form" id="inq_detailForm">
                <!-- 기본정보 섹션 -->
                <section class="illegal-inquiry-form__section">
                  ...
                  <div class="illegal-inquiry-grid illegal-inquiry-grid--cols-3">
                    <div class="illegal-inquiry-field">
                      ...
                      <span class="illegal-inquiry-text" id="inq_detail_hdqrNm"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">지사</label>
                      <span class="illegal-inquiry-text" id="inq_detail_mtnofNm"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">노선</label>
                      <span class="illegal-inquiry-text" id="inq_detail_routeCd"></span>
                    </div>
                  </div>
                  ...
                  <div class="illegal-inquiry-grid illegal-inquiry-grid--cols-3">
                    <div class="illegal-inquiry-field">
                      ...
                      <span class="illegal-inquiry-text" id="inq_detail_drveDrctCd"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">이정(km)</label>
                      <span class="illegal-inquiry-text" id="inq_detail_routeDstnc"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">구분</label>
                      <span class="illegal-inquiry-text" id="inq_detail_strcClssCd"></span>
                    </div>
                  </div>
                </section>
                ...
                <section class="illegal-inquiry-form__section">
                  ...
                  <div class="illegal-inquiry-grid illegal-inquiry-grid--cols-1">
                    <div class="illegal-inquiry-field illegal-inquiry-field--row">
                      ...
                      <span class="illegal-inquiry-text" id="inq_detail_lndsLdnoAddr"></span>
                    </div>
                  </div>
                </section>
                ...
                <section class="illegal-inquiry-form__section">
                  ...
                  <div class="illegal-inquiry-grid illegal-inquiry-grid--cols-4">
                    <div class="illegal-inquiry-field">
                      ...
                      <span class="illegal-inquiry-text" id="inq_detail_ocrnDates"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">담당자</label>
                      <span class="illegal-inquiry-text" id="inq_detail_prchEmno"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">행위자명</label>
                      <span class="illegal-inquiry-text" id="inq_detail_trnrNm"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">관련자</label>
                      <span class="illegal-inquiry-text" id="inq_detail_rltrNm"></span>
                    </div>
                  </div>
                  ...
                  <div class="illegal-inquiry-grid illegal-inquiry-grid--cols-2">
                    <div class="illegal-inquiry-field">
                      ...
                      <span class="illegal-inquiry-text" id="inq_detail_trnrAddr"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">관련자 주소</label>
                      <span class="illegal-inquiry-text" id="inq_detail_rltrAddr"></span>
                    </div>
                  </div>
                </section>
                ...
                <section class="illegal-inquiry-form__section">
                  ...
                  <div class="illegal-inquiry-grid illegal-inquiry-grid--cols-3">
                    <div class="illegal-inquiry-field">
                      ...
                      <span class="illegal-inquiry-text" id="inq_detail_ilglPssrt"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">점유면적 (㎡)</label>
                      <span class="illegal-inquiry-text" id="inq_detail_ilglPssnSqms"></span>
                    </div>
                    <div class="illegal-inquiry-field">
                      <label class="illegal-inquiry-label">조치상태</label>
                      <span class="illegal-inquiry-text" id="inq_detail_ilglPrvuActnStatVal"></span>
                    </div>
                  </div>
                </section>
                ...
                <section class="illegal-inquiry-form__section">
                  ...
                  <div class="illegal-inquiry-action-history" id="inq_detailActionHistory"></div>
                </section>
              </div>
            </div>
          </div>
