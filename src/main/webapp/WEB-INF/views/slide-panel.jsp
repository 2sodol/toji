  ...
  <div id="slide-panel" class="slide-panel">
    ...
    <div class="slide-panel__body">
      ...
      <div class="slide-panel-search">
        <div class="slide-panel-search__input-wrapper">
          <input type="text" id="slide-panel-search-input" class="slide-panel-search__input" placeholder="주소 검색" />
          <button type="button" id="slide-panel-search-clear" class="slide-panel-search__clear">
            <i class="fas fa-times"></i>
          </button>
        </div>
        <button type="button" id="slide-panel-search-btn" class="slide-panel-search__btn">
      ...
      <div id="slide-panel-list-wrapper" class="slide-panel-list-wrapper">
        <div id="slide-panel-list-container" class="slide-panel-list-container">
          ...
          <div class="slide-panel-list-header">
            <div class="slide-panel-list-header__cell slide-panel-list-header__cell--sequence">
              번호
            </div>
            <div class="slide-panel-list-header__cell slide-panel-list-header__cell--address">
              주소
            </div>
          </div>

          <!-- 리스트 아이템 컨테이너 -->
          <div id="slide-panel-list-items"></div>
        ...
        <div id="slide-panel-loading" class="slide-panel-loading" style="display: none">
          <div class="slide-panel-loading__spinner"></div>
        </div>
